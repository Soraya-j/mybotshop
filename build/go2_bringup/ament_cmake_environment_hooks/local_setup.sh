...
: ${AMENT_CURRENT_PREFIX:="/opt/mybotshop/install/go2_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_bringup/environment/pythonpath.sh"
