...
: ${AMENT_CURRENT_PREFIX:="/opt/mybotshop/install/odom_to_tf_ros2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/odom_to_tf_ros2/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/odom_to_tf_ros2/environment/path.sh"
