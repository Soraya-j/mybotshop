...
: ${AMENT_CURRENT_PREFIX:="/opt/mybotshop/install/go2w_actuator_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2w_actuator_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2w_actuator_control/environment/path.sh"
