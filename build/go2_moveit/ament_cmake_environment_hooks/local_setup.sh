...
: ${AMENT_CURRENT_PREFIX:="/opt/mybotshop/install/go2_moveit"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_moveit/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_moveit/environment/path.sh"
