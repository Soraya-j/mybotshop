  ...
  void * untyped_ros_message)
{
  ...
  // Field name: param
  {
    ...
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->param, size)) {
      return "failed to create array for field 'param'";
    }
    auto array_ptr = ros_message->param.data;
...
static size_t _SetDrawingTrajectory_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_open_manipulator_msgs__srv__SetDrawingTrajectory_Request(
    full_bounded, 0);
}
...
static size_t _SetDrawingTrajectory_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_open_manipulator_msgs__srv__SetDrawingTrajectory_Response(
    full_bounded, 0);
}
