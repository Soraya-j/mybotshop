...
#include "open_manipulator_msgs/srv/detail/set_joint_position__rosidl_typesupport_fastrtps_c.h"
...
using _SetJointPosition_Request__ros_msg_type = open_manipulator_msgs__srv__SetJointPosition_Request;
...
size_t get_serialized_size_open_manipulator_msgs__srv__SetJointPosition_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetJointPosition_Request__ros_msg_type * ros_message = static_cast<const _SetJointPosition_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetJointPosition_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_open_manipulator_msgs__srv__SetJointPosition_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_open_manipulator_msgs
size_t max_serialized_size_open_manipulator_msgs__srv__SetJointPosition_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_open_manipulator_msgs__srv__SetJointPosition_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, open_manipulator_msgs, srv, SetJointPosition_Request)() {
...
using _SetJointPosition_Response__ros_msg_type = open_manipulator_msgs__srv__SetJointPosition_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_open_manipulator_msgs
size_t get_serialized_size_open_manipulator_msgs__srv__SetJointPosition_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetJointPosition_Response__ros_msg_type * ros_message = static_cast<const _SetJointPosition_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_open_manipulator_msgs__srv__SetJointPosition_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_open_manipulator_msgs
size_t max_serialized_size_open_manipulator_msgs__srv__SetJointPosition_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_open_manipulator_msgs__srv__SetJointPosition_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, open_manipulator_msgs, srv, SetJointPosition_Response)() {
...
// already included above
// #include "open_manipulator_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "open_manipulator_msgs/srv/set_joint_position.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, open_manipulator_msgs, srv, SetJointPosition)() {
