...
#include "open_manipulator_msgs/msg/detail/kinematics_pose__rosidl_typesupport_fastrtps_c.h"
...
using _KinematicsPose__ros_msg_type = open_manipulator_msgs__msg__KinematicsPose;
...
static uint32_t _KinematicsPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_open_manipulator_msgs__msg__KinematicsPose(
...
{
  return max_serialized_size_open_manipulator_msgs__msg__KinematicsPose(
    full_bounded, 0);
}
