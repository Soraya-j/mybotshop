...
void SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_init_function(
...
void SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_fini_function(void * message_memory)
{
  open_manipulator_msgs__srv__SetKinematicsPose_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_message_member_array[4] = {
  {
    "planning_group",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_message_members = {
  ...
  SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_message_member_array,  // message members
  SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_message_type_support_handle = {
  0,
  &SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, open_manipulator_msgs, srv, SetKinematicsPose_Request)() {
  SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_message_member_array[2].members_ =
  ...
  if (!SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_message_type_support_handle.typesupport_identifier) {
    SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SetKinematicsPose_Request__rosidl_typesupport_introspection_c__SetKinematicsPose_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void SetKinematicsPose_Response__rosidl_typesupport_introspection_c__SetKinematicsPose_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void SetKinematicsPose_Response__rosidl_typesupport_introspection_c__SetKinematicsPose_Response_fini_function(void * message_memory)
{
  open_manipulator_msgs__srv__SetKinematicsPose_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetKinematicsPose_Response__rosidl_typesupport_introspection_c__SetKinematicsPose_Response_message_member_array[1] = {
  {
    "is_planned",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SetKinematicsPose_Response__rosidl_typesupport_introspection_c__SetKinematicsPose_Response_message_members = {
  "open_manipulator_msgs__srv",  // message namespace
  "SetKinematicsPose_Response",  // message name
  1,  // number of fields
  sizeof(open_manipulator_msgs__srv__SetKinematicsPose_Response),
  SetKinematicsPose_Response__rosidl_typesupport_introspection_c__SetKinematicsPose_Response_message_member_array,  // message members
  SetKinematicsPose_Response__rosidl_typesupport_introspection_c__SetKinematicsPose_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  SetKinematicsPose_Response__rosidl_typesupport_introspection_c__SetKinematicsPose_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SetKinematicsPose_Response__rosidl_typesupport_introspection_c__SetKinematicsPose_Response_message_type_support_handle = {
  0,
  &SetKinematicsPose_Response__rosidl_typesupport_introspection_c__SetKinematicsPose_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, open_manipulator_msgs, srv, SetKinematicsPose_Response)() {
  if (!SetKinematicsPose_Response__rosidl_typesupport_introspection_c__SetKinematicsPose_Response_message_type_support_handle.typesupport_identifier) {
    SetKinematicsPose_Response__rosidl_typesupport_introspection_c__SetKinematicsPose_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SetKinematicsPose_Response__rosidl_typesupport_introspection_c__SetKinematicsPose_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
