...
void GetJointPosition_Request__rosidl_typesupport_introspection_c__GetJointPosition_Request_init_function(
...
void GetJointPosition_Request__rosidl_typesupport_introspection_c__GetJointPosition_Request_fini_function(void * message_memory)
{
  open_manipulator_msgs__srv__GetJointPosition_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetJointPosition_Request__rosidl_typesupport_introspection_c__GetJointPosition_Request_message_member_array[1] = {
  {
    "planning_group",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetJointPosition_Request__rosidl_typesupport_introspection_c__GetJointPosition_Request_message_members = {
  ...
  GetJointPosition_Request__rosidl_typesupport_introspection_c__GetJointPosition_Request_message_member_array,  // message members
  GetJointPosition_Request__rosidl_typesupport_introspection_c__GetJointPosition_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetJointPosition_Request__rosidl_typesupport_introspection_c__GetJointPosition_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetJointPosition_Request__rosidl_typesupport_introspection_c__GetJointPosition_Request_message_type_support_handle = {
  0,
  &GetJointPosition_Request__rosidl_typesupport_introspection_c__GetJointPosition_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, open_manipulator_msgs, srv, GetJointPosition_Request)() {
  if (!GetJointPosition_Request__rosidl_typesupport_introspection_c__GetJointPosition_Request_message_type_support_handle.typesupport_identifier) {
    GetJointPosition_Request__rosidl_typesupport_introspection_c__GetJointPosition_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetJointPosition_Request__rosidl_typesupport_introspection_c__GetJointPosition_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_fini_function(void * message_memory)
{
  open_manipulator_msgs__srv__GetJointPosition_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_message_member_array[1] = {
  {
    "joint_position",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_message_members = {
  "open_manipulator_msgs__srv",  // message namespace
  "GetJointPosition_Response",  // message name
  1,  // number of fields
  sizeof(open_manipulator_msgs__srv__GetJointPosition_Response),
  GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_message_member_array,  // message members
  GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_message_type_support_handle = {
  0,
  &GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, open_manipulator_msgs, srv, GetJointPosition_Response)() {
  GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_message_member_array[0].members_ =
  ...
  if (!GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_message_type_support_handle.typesupport_identifier) {
    GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetJointPosition_Response__rosidl_typesupport_introspection_c__GetJointPosition_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
