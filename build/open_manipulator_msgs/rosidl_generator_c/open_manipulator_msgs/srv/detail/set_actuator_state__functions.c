  ...
  open_manipulator_msgs__srv__SetActuatorState_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    open_manipulator_msgs__srv__SetActuatorState_Request * data =
      (open_manipulator_msgs__srv__SetActuatorState_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!open_manipulator_msgs__srv__SetActuatorState_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          open_manipulator_msgs__srv__SetActuatorState_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  open_manipulator_msgs__srv__SetActuatorState_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    open_manipulator_msgs__srv__SetActuatorState_Response * data =
      (open_manipulator_msgs__srv__SetActuatorState_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!open_manipulator_msgs__srv__SetActuatorState_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          open_manipulator_msgs__srv__SetActuatorState_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
