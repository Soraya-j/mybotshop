...
: ${AMENT_CURRENT_PREFIX:="/opt/mybotshop/install/go2_viz"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_viz/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_viz/environment/path.sh"
