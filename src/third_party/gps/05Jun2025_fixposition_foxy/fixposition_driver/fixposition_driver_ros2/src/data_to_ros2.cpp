...
void FpToRosMsg(const FP_GNSSANT& data, rclcpp::Publisher<fixposition_msgs::msg::GNSSANT>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::GNSSANT msg;
...
void FpToRosMsg(const FP_GNSSCORR& data, rclcpp::Publisher<fixposition_msgs::msg::GNSSCORR>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::GNSSCORR msg;
...
void FpToRosMsg(const FP_LLH& data, rclcpp::Publisher<fixposition_msgs::msg::LLH>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::LLH msg;
...
void FpToRosMsg(const FP_ODOMENU& data, rclcpp::Publisher<fixposition_msgs::msg::ODOMENU>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::ODOMENU msg;
...
void FpToRosMsg(const FP_ODOMETRY& data, rclcpp::Publisher<fixposition_msgs::msg::ODOMETRY>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::ODOMETRY msg;
...
void FpToRosMsg(const FP_ODOMSH& data, rclcpp::Publisher<fixposition_msgs::msg::ODOMSH>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::ODOMSH msg;
...
void FpToRosMsg(const FP_TEXT& data, rclcpp::Publisher<fixposition_msgs::msg::TEXT>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::TEXT msg;
...
void FpToRosMsg(const GP_GGA& data, rclcpp::Publisher<fixposition_msgs::msg::GPGGA>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::GPGGA msg;
...
void FpToRosMsg(const GP_GLL& data, rclcpp::Publisher<fixposition_msgs::msg::GPGLL>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::GPGLL msg;
...
void FpToRosMsg(const GN_GSA& data, rclcpp::Publisher<fixposition_msgs::msg::GNGSA>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::GNGSA msg;
...
void FpToRosMsg(const GP_GST& data, rclcpp::Publisher<fixposition_msgs::msg::GPGST>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::GPGST msg;
...
void FpToRosMsg(const GX_GSV& data, rclcpp::Publisher<fixposition_msgs::msg::GXGSV>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::GXGSV msg;
...
void FpToRosMsg(const GP_HDT& data, rclcpp::Publisher<fixposition_msgs::msg::GPHDT>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::GPHDT msg;
...
void FpToRosMsg(const GP_RMC& data, rclcpp::Publisher<fixposition_msgs::msg::GPRMC>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::GPRMC msg;
...
void FpToRosMsg(const GP_VTG& data, rclcpp::Publisher<fixposition_msgs::msg::GPVTG>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::GPVTG msg;
...
void FpToRosMsg(const GP_ZDA& data, rclcpp::Publisher<fixposition_msgs::msg::GPZDA>::SharedPtr pub) {
    if (pub->get_subscription_count() > 0) {
        // Create message
        fixposition_msgs::msg::GPZDA msg;
