...
FixpositionDriverNode::FixpositionDriverNode(std::shared_ptr<rclcpp::Node> node, const FixpositionDriverParams& params, rclcpp::QoS qos_settings)
    : FixpositionDriver(params),
      ...
      // FP_A messages
      fpa_odometry_pub_(node_->create_publisher<fixposition_msgs::msg::ODOMETRY>("/fixposition/fpa/odometry", qos_settings)),
      fpa_llh_pub_(node_->create_publisher<fixposition_msgs::msg::LLH>("/fixposition/fpa/llh", qos_settings)),
      fpa_odomenu_pub_(node_->create_publisher<fixposition_msgs::msg::ODOMENU>("/fixposition/fpa/odomenu", qos_settings)),
      fpa_odomsh_pub_(node_->create_publisher<fixposition_msgs::msg::ODOMSH>("/fixposition/fpa/odomsh", qos_settings)),
      fpa_gnssant_pub_(node_->create_publisher<fixposition_msgs::msg::GNSSANT>("/fixposition/fpa/gnssant", qos_settings)),
      fpa_gnsscorr_pub_(node_->create_publisher<fixposition_msgs::msg::GNSSCORR>("/fixposition/fpa/gnsscorr", qos_settings)),
      fpa_text_pub_(node_->create_publisher<fixposition_msgs::msg::TEXT>("/fixposition/fpa/text", qos_settings)),

      // NMEA messages
      nmea_gpgga_pub_(node_->create_publisher<fixposition_msgs::msg::GPGGA>("/fixposition/nmea/gpgga", qos_settings)),
      nmea_gpgll_pub_(node_->create_publisher<fixposition_msgs::msg::GPGLL>("/fixposition/nmea/gpgll", qos_settings)),
      nmea_gngsa_pub_(node_->create_publisher<fixposition_msgs::msg::GNGSA>("/fixposition/nmea/gngsa", qos_settings)),
      nmea_gpgst_pub_(node_->create_publisher<fixposition_msgs::msg::GPGST>("/fixposition/nmea/gpgst", qos_settings)),
      nmea_gxgsv_pub_(node_->create_publisher<fixposition_msgs::msg::GXGSV>("/fixposition/nmea/gxgsv", qos_settings)),
      nmea_gphdt_pub_(node_->create_publisher<fixposition_msgs::msg::GPHDT>("/fixposition/nmea/gphdt", qos_settings)),
      nmea_gprmc_pub_(node_->create_publisher<fixposition_msgs::msg::GPRMC>("/fixposition/nmea/gprmc", qos_settings)),
      nmea_gpvtg_pub_(node_->create_publisher<fixposition_msgs::msg::GPVTG>("/fixposition/nmea/gpvtg", qos_settings)),
      nmea_gpzda_pub_(node_->create_publisher<fixposition_msgs::msg::GPZDA>("/fixposition/nmea/gpzda", qos_settings)),
      ...
      // GNSS
      nmea_pub_(node_->create_publisher<fixposition_msgs::msg::NMEA>("/fixposition/nmea", qos_settings)),
...
{
    ws_sub_ = node_->create_subscription<fixposition_msgs::msg::Speed>(
...
void FixpositionDriverNode::PublishNmea() {
    ...
    if (nmea_message_.checkEpoch()) {
        ...
        for (auto gsv_it = nmea_message_.gnss_signals.begin(); gsv_it != nmea_message_.gnss_signals.end(); ++gsv_it) {
            ...
            fixposition_msgs::msg::Gnsssats sats_msg;
...
void FixpositionDriverNode::WsCallback(const fixposition_msgs::msg::Speed::ConstSharedPtr msg) {
