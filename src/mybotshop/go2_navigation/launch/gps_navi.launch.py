...
def generate_launch_description():
    ...
    remappings = [('/diagnostics', f'/{nsp}/diagnostics'),
                  ('/tf', f'/{nsp}/tf'),
    ...
    load_nodes = GroupAction(
        ...
        actions=[
            Node(
                ...
                remappings=remappings + [('cmd_vel', f'/{nsp}/autonomous_low_priority/cmd_vel')]),
            Node(
                namespace=nsp,
            ...
            Node(
                ...
                arguments=['--ros-args', '--log-level', log_level],
                remappings=remappings +
                        [('cmd_vel', 'cmd_vel_nav'), ('cmd_vel_smoothed', f'/{nsp}/autonomous_low_priority/cmd_vel')]),
            Node(
                namespace=nsp,
