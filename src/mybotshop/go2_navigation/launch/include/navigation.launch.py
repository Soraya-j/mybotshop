...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('go2_navigation')
    ...
    # When nodes run inside namespace=nsp, relative topics like 'scan'
    # automatically become /{nsp}/scan. Only global topics (starting with /)
    # need explicit remapping to pull them into the namespace.
    rmp = [('/tf', f'/{nsp}/tf'),
           ('/tf_static', f'/{nsp}/tf_static'),
           ('/diagnostics', f'/{nsp}/diagnostics'),
           ('scan', f'/{nsp}/scan'),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'param', 'nav2_map.yaml'),
