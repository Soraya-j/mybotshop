...
```bash
ros2 run nav2_map_server map_saver_cli -f /opt/mybotshop/src/mybotshop/go2_navigation/maps/custom_map   --ros-args --remap map:=/$GO2_NS/map
ros2 run nav2_map_server map_saver_cli -f /opt/mybotshop/src/mybotshop/go2_navigation/maps/custom_map_2 --ros-args --remap map:=/$GO2_NS/map
```
...
```bash
ros2 launch go2_navigation gps_navi.launch.py
```
