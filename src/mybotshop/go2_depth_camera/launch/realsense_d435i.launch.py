...
configurable_parameters = [{'name': 'camera_namespace',             'default': nsp,
                               'description': 'namespace for camera'},
                           {'name': 'camera_name',                  'default': nsp,
                           ...
                           {'name': 'infra_rgb',                    'default': 'false',
                               'description': 'enable infra2 stream'},
                           {'name': 'tracking_module.profile',
                               'default': '0,0,0', 'description': 'fisheye width'},
                           ...
                           {'name': 'pointcloud.pointcloud_qos',
                               'default': 'SENSOR_DATA', 'description': 'pointcloud qos'},
