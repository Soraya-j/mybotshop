...
configurable_parameters = [{'name': 'camera_namespace',             'default': 'go2', 'description': 'namespace for camera'},
                           {'name': 'camera_name',                  'default': 'd405', 'description': 'camera unique name'},
                           {'name': 'serial_no',                    'default': "'323622270884'", 'description': 'choose device by serial number'},
